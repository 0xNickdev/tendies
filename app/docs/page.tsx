...
export const metadata: Metadata = {
  ...
  description:
    "Full documentation for Tendies: the PERPTENDIES token (Tendies, Perps & Stonks) on Solana, the 0.5% treasury fee, 30-minute tokenized-stock rewards (OpenAI · TSLA · NVDA · SPCX), perps, the keeper, and security.",
};
          ...
          <div className="mt-10 space-y-10">
            <Section id="overview" n="01" title="Overview">
              <p>
                ...
                <b className="text-white">PERPTENDIES</b> token and the treasury pays
            ...
            <Section id="how" n="02" title="How it works">
              ...
              <ol className="ml-1 space-y-3">
                {[
                  ["Trade fee → treasury", "PERPTENDIES itself is untaxed. Its pool on stonkfun charges 1.25% per trade, of which 0.5% is routed to the treasury and the rest kept by the launchpad."],
              ...
              <p className="rounded-lg border border-tendie/20 bg-tendie/5 p-4 text-sm text-mist-200">
                ...
                in the token PERPTENDIES is paired against - OPENAI - so that is what
            ...
            <Section id="tokenomics" n="03" title="Tokenomics">
              <div className="panel p-6">
                <Row k="Token" v="Tendies, Perps & Stonks (PERPTENDIES)" />
            ...
            <Section id="rewards" n="04" title="Rewards & distribution">
              <div className="panel p-6">
                ...
                <Row k="Eligibility" v="Pro-rata to every PERPTENDIES holder" />
            ...
            <Section id="contracts" n="08" title="Programs & security">
              ...
              <ul className="space-y-2 text-sm">
                <li className="panel p-4">
                  <b className="text-white">PERPTENDIES</b> - the token. Fixed 1B
              ...
              <div className="panel p-5 text-sm">
                <div className="flex flex-col gap-2">
                  <AddrLink label="PERPTENDIES mint" address={TENDIE_MINT} />
            ...
            <Section id="faq" n="09" title="FAQ">
              {[
                ["Do I own real shares?", "No. Rewards are tokenized stocks (xStocks 1:1-backed; OPENAI is SPV-backed pre-IPO exposure) held in your wallet; PERPTENDIES itself is a utility token with no equity or shareholder rights. Not affiliated with the underlying companies."],
                ...
                ["Can the team rug the fee?", "PERPTENDIES launches on the stonkfun launchpad, so the mint and the bonding curve are the launchpad's, not ours - mint authority is not ours to abuse. The treasury wallet that receives the fee is published and its payouts are visible on Solscan."],
