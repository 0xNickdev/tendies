...
export const FEATURES = {
  tradeLive: false, // unlocks with the PERPTENDIE token launch (see lib/config.ts)
...
export const TREASURY = {
  ...
  // PERPTENDIE is priced against this, not against a stablecoin.
  quoteSymbol: "OPENAI",
  tokenPriceUsd: 0,
  tokenSymbol: "PERPTENDIE",
...
// Solana mainnet-beta — PERPTENDIE launches on the stonkfun launchpad.
