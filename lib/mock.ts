...
export const FEATURES = {
  tradeLive: false, // unlocks with the PERPTENDIES token launch (see lib/config.ts)
...
export const TREASURY = {
  ...
  // PERPTENDIES is priced against this, not against a stablecoin.
  quoteSymbol: "OPENAI",
  tokenPriceUsd: 0,
  tokenSymbol: "PERPTENDIES",
...
// Solana mainnet-beta — PERPTENDIES launches on the stonkfun launchpad.
