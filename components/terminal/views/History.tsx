                  ...
                  {history.map((p) => {
                    ...
                    return (
                      <tr key={p.id} className="hover:bg-robin/5">
                        ...
                        <td className="num px-5 py-4 text-zinc-300">{fmtUSD(p.marginUsd)}</td>
                        <td className="num px-5 py-4 text-zinc-400">−{fmtUSD(p.fundingPaidUsd)}</td>
                        <td className="px-5 py-4 text-zinc-400">{fmtDate(p.closedAt)}</td>
