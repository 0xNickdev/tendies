      ...
      <div className="grid items-start gap-12 lg:grid-cols-2">
        <Reveal>
          ...
          <p className="mt-6 text-pretty leading-relaxed text-mist-300">
            ...
            reward. Hold TENDIEPERP and the treasury pays you tokenized OpenAI,
          ...
          <p className="mt-4 text-pretty leading-relaxed text-mist-300">
            The token itself grants no equity. TENDIEPERP carries no transfer tax at
        ...
        <Reveal delay={120} className="panel p-6">
          ...
          <div className="mt-2 border-t border-tendie/15 pt-4 font-mono text-sm text-mist-300">
            Hold TENDIEPERP → the treasury pays you these real tokenized stocks,
...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Solana. TENDIEPERP launches on the stonkfun launchpad - connect Phantom or Solflare and you're in. No network to add, no bridge.",
    },
  ];
  return (
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-5 py-12 sm:px-6 md:flex-row md:items-start md:justify-between">
        <div className="max-w-xs">
          ...
          <p className="mt-4 text-sm leading-relaxed text-mist-400">
            Hold TENDIEPERP, get paid in real tokenized stocks every 30 minutes. Not
