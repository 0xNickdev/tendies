...
- Hold **$TENDIE** → earn rewards in **1:1-backed tokenized stocks**
...
| Phase | Status | What |
| ----- | ------ | ---- |
| **01 · Token & Treasury** | 🟢 Shipped | TENDIE/OPENAI on stonkfun + 0.5% creator fee, stock rewards (your pick), 30-min distribution, live Nasdaq feed, full terminal |
...
*Tendies is a synthetic/DeFi protocol. TENDIE and stock-token rewards confer
