...
- Hold **$PTNDS** → earn rewards in **1:1-backed tokenized stocks**
...
1. **Trade fee → treasury.** PTNDS itself is untaxed. Its pool on stonkfun
...
| Eligibility      | Pro-rata to every PTNDS holder                |
...
| Total supply     | 1,000,000,000 PTNDS                         |
...
| Phase | Status | What |
| ----- | ------ | ---- |
| **01 · Token & Treasury** | 🟢 Shipped | PTNDS/OPENAI on stonkfun + 0.5% creator fee, stock rewards (your pick), 30-min distribution, live Nasdaq feed, full terminal |
...
*Tendies is a synthetic/DeFi protocol. PTNDS and stock-token rewards confer
