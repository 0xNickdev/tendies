...
1. **Snapshots holders** — enumerates every TENDIEPERP token account straight from
...
No custom on-chain program is involved: TENDIEPERP is minted by the **stonkfun**
...
- Verify every mint you paste (TENDIEPERP, the xStocks, `FEE_MINT`) on solscan.io.
