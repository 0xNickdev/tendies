...
1. **Snapshots holders** — enumerates every PERPTENDIES token account straight from
...
No custom on-chain program is involved: PERPTENDIES is minted by the **stonkfun**
...
- Verify every mint you paste (PERPTENDIES, the xStocks, `FEE_MINT`) on solscan.io.
