...
1. **Snapshots holders** — enumerates every PERPTENDIE token account straight from
...
No custom on-chain program is involved: PERPTENDIE is minted by the **stonkfun**
...
- Verify every mint you paste (PERPTENDIE, the xStocks, `FEE_MINT`) on solscan.io.
